...
import sandbox.TypeClassTypeBound.TypeClassesSandbox.EqualsSandbox.Equal
import sandbox.TypeClassTypeBound.TypeClassesSandbox.EqualsSandbox.Equal.ToEqual
